...
class paidAdDAO {
    ...
    public function getAdByIP($provi)
   {
       ...
       $query = "select ad.ad_id, ad.ad_title, ad.ad_category_id, cat.ad_category, 
                 ...
                 ad.ad_city, ad.search_tags,
                 ad.ad_flag, ad.ad_addr, ad.ad_province_id, prov.province, ad.ad_zip
                 from tbl_advertisement ad, tbl_ad_category cat, tbl_provinces prov
                 where cat.ad_category_id = ad.ad_category_id 
                     and prov.province LIKE '".$provi."%'
